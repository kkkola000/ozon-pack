"""Общие мелочи разбора ответов площадок и полей для шаблонов.

Свои ответы каждая площадка разбирает у себя (markets/<код>/store.py); здесь
то, что одинаково у всех: приведение дат и чисел, местное время, срочность по
сроку отгрузки, отметки сборщика на возвратах.
"""
